...
def rank(input_path):
    ...
    for line in test_lines:
        sentence, candidates, ranks, complex_word = preprocess_line(line)
        # print(sentence)
        print(complex_word)
        if sentence is not None:
            ...
            with open("/home/dina/Semesters/GP/Lexical Simplification/App/simplifier/model/output.txt", "w+") as f:
                # f.write("<original> ")
                # f.write(original)
                # f.write("\n<simplified> ")
                f.write(sentence)
